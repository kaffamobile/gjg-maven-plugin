...
class GjgHandler(
    ...
    override fun run() {
        ...
        val outputGjgConfigFile = File(outputGjgExeFile.parentFile, "${outputGjgExeFile.nameWithoutExtension}.gjg.conf")

        extractGjg(outputGjgExeFile)
        setIconAndMetadatas(outputGjgExeFile)
        writeConfigFile(outputGjgConfigFile)
    }
    ...
    private fun writeConfigFile(configFile: File) {
        ...
        log.info("Writed config file $configFile\n${configFile.readText()}")
    }
